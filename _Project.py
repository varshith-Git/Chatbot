...
entry = Text (bottom_frame , bg = c3 , fg = 'white' ,relief = "flat", height = '5'  , width ='45' , font  ='Verdana 10')
...
button_write = Button (bottom_frame , text = 'write' ,bg = 'white' ,fg = 'white' , font = 'Vardana 8' ,  command = write_file )
